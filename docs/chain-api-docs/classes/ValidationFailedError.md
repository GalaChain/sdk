...
[API](../exports.md) > ValidationFailedError

# Class: ValidationFailedError

## Contents

- [Extends](ValidationFailedError.md#extends)
- [Constructors](ValidationFailedError.md#constructors)
  - [new ValidationFailedError(args)](ValidationFailedError.md#new-validationfailederrorargs)
- [Properties](ValidationFailedError.md#properties)
  - [code](ValidationFailedError.md#code)
  - [key](ValidationFailedError.md#key)
  - [message](ValidationFailedError.md#message)
  - [name](ValidationFailedError.md#name)
  - [payload](ValidationFailedError.md#payload)
  - [stack](ValidationFailedError.md#stack)
- [Methods](ValidationFailedError.md#methods)
  - [andExec()](ValidationFailedError.md#andexec)
  - [logError()](ValidationFailedError.md#logerror)
  - [logWarn()](ValidationFailedError.md#logwarn)
  - [map()](ValidationFailedError.md#map)
  - [matches()](ValidationFailedError.md#matches)
...
### new ValidationFailedError(args)

> **new ValidationFailedError**(...`args`): [`ValidationFailedError`](ValidationFailedError.md)
