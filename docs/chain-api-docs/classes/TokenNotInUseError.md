...
[API](../exports.md) > TokenNotInUseError

# Class: TokenNotInUseError

## Contents

- [Extends](TokenNotInUseError.md#extends)
- [Constructors](TokenNotInUseError.md#constructors)
  - [new TokenNotInUseError(owner, tokenClass, instanceId)](TokenNotInUseError.md#new-tokennotinuseerrorowner-tokenclass-instanceid)
- [Properties](TokenNotInUseError.md#properties)
  - [code](TokenNotInUseError.md#code)
  - [key](TokenNotInUseError.md#key)
  - [message](TokenNotInUseError.md#message)
  - [name](TokenNotInUseError.md#name)
  - [payload](TokenNotInUseError.md#payload)
  - [stack](TokenNotInUseError.md#stack)
- [Methods](TokenNotInUseError.md#methods)
  - [andExec()](TokenNotInUseError.md#andexec)
  - [logError()](TokenNotInUseError.md#logerror)
  - [logWarn()](TokenNotInUseError.md#logwarn)
  - [map()](TokenNotInUseError.md#map)
  - [matches()](TokenNotInUseError.md#matches)
...
### new TokenNotInUseError(owner, tokenClass, instanceId)

> **new TokenNotInUseError**(`owner`, `tokenClass`, `instanceId`): [`TokenNotInUseError`](TokenNotInUseError.md)
...
[chain-api/src/types/TokenBalance.ts:78](https://github.com/GalaChain/sdk/blob/bcbbb18/chain-api/src/types/TokenBalance.ts#L78)
