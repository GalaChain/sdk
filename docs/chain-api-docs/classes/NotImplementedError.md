...
[API](../exports.md) > NotImplementedError

# Class: NotImplementedError

## Contents

- [Extends](NotImplementedError.md#extends)
- [Constructors](NotImplementedError.md#constructors)
  - [new NotImplementedError(args)](NotImplementedError.md#new-notimplementederrorargs)
- [Properties](NotImplementedError.md#properties)
  - [code](NotImplementedError.md#code)
  - [key](NotImplementedError.md#key)
  - [message](NotImplementedError.md#message)
  - [name](NotImplementedError.md#name)
  - [payload](NotImplementedError.md#payload)
  - [stack](NotImplementedError.md#stack)
- [Methods](NotImplementedError.md#methods)
  - [andExec()](NotImplementedError.md#andexec)
  - [logError()](NotImplementedError.md#logerror)
  - [logWarn()](NotImplementedError.md#logwarn)
  - [map()](NotImplementedError.md#map)
  - [matches()](NotImplementedError.md#matches)
...
### new NotImplementedError(args)

> **new NotImplementedError**(...`args`): [`NotImplementedError`](NotImplementedError.md)
