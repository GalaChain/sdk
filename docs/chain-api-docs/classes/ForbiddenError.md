...
[API](../exports.md) > ForbiddenError

# Class: ForbiddenError

## Contents

- [Extends](ForbiddenError.md#extends)
- [Constructors](ForbiddenError.md#constructors)
  - [new ForbiddenError(args)](ForbiddenError.md#new-forbiddenerrorargs)
- [Properties](ForbiddenError.md#properties)
  - [code](ForbiddenError.md#code)
  - [key](ForbiddenError.md#key)
  - [message](ForbiddenError.md#message)
  - [name](ForbiddenError.md#name)
  - [payload](ForbiddenError.md#payload)
  - [stack](ForbiddenError.md#stack)
- [Methods](ForbiddenError.md#methods)
  - [andExec()](ForbiddenError.md#andexec)
  - [logError()](ForbiddenError.md#logerror)
  - [logWarn()](ForbiddenError.md#logwarn)
  - [map()](ForbiddenError.md#map)
  - [matches()](ForbiddenError.md#matches)
...
> **new ForbiddenError**(...`args`): [`ForbiddenError`](ForbiddenError.md)
