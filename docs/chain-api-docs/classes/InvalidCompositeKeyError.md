...
[API](../exports.md) > InvalidCompositeKeyError

# Class: InvalidCompositeKeyError

## Contents

- [Extends](InvalidCompositeKeyError.md#extends)
- [Constructors](InvalidCompositeKeyError.md#constructors)
  - [new InvalidCompositeKeyError(message)](InvalidCompositeKeyError.md#new-invalidcompositekeyerrormessage)
- [Properties](InvalidCompositeKeyError.md#properties)
  - [code](InvalidCompositeKeyError.md#code)
  - [key](InvalidCompositeKeyError.md#key)
  - [message](InvalidCompositeKeyError.md#message)
  - [name](InvalidCompositeKeyError.md#name)
  - [payload](InvalidCompositeKeyError.md#payload)
  - [stack](InvalidCompositeKeyError.md#stack)
- [Methods](InvalidCompositeKeyError.md#methods)
  - [andExec()](InvalidCompositeKeyError.md#andexec)
  - [logError()](InvalidCompositeKeyError.md#logerror)
  - [logWarn()](InvalidCompositeKeyError.md#logwarn)
  - [map()](InvalidCompositeKeyError.md#map)
  - [matches()](InvalidCompositeKeyError.md#matches)
...
### new InvalidCompositeKeyError(message)

> **new InvalidCompositeKeyError**(`message`): [`InvalidCompositeKeyError`](InvalidCompositeKeyError.md)
...
[chain-api/src/types/ChainObject.ts:35](https://github.com/GalaChain/sdk/blob/bcbbb18/chain-api/src/types/ChainObject.ts#L35)
