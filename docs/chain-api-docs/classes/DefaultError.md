...
[API](../exports.md) > DefaultError

# Class: DefaultError

## Contents

- [Extends](DefaultError.md#extends)
- [Constructors](DefaultError.md#constructors)
  - [new DefaultError(args)](DefaultError.md#new-defaulterrorargs)
- [Properties](DefaultError.md#properties)
  - [code](DefaultError.md#code)
  - [key](DefaultError.md#key)
  - [message](DefaultError.md#message)
  - [name](DefaultError.md#name)
  - [payload](DefaultError.md#payload)
  - [stack](DefaultError.md#stack)
- [Methods](DefaultError.md#methods)
  - [andExec()](DefaultError.md#andexec)
  - [logError()](DefaultError.md#logerror)
  - [logWarn()](DefaultError.md#logwarn)
  - [map()](DefaultError.md#map)
  - [matches()](DefaultError.md#matches)
...
### new DefaultError(args)

> **new DefaultError**(...`args`): [`DefaultError`](DefaultError.md)
