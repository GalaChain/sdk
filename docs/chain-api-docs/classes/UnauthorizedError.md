...
[API](../exports.md) > UnauthorizedError

# Class: UnauthorizedError

## Contents

- [Extends](UnauthorizedError.md#extends)
- [Constructors](UnauthorizedError.md#constructors)
  - [new UnauthorizedError(args)](UnauthorizedError.md#new-unauthorizederrorargs)
- [Properties](UnauthorizedError.md#properties)
  - [code](UnauthorizedError.md#code)
  - [key](UnauthorizedError.md#key)
  - [message](UnauthorizedError.md#message)
  - [name](UnauthorizedError.md#name)
  - [payload](UnauthorizedError.md#payload)
  - [stack](UnauthorizedError.md#stack)
- [Methods](UnauthorizedError.md#methods)
  - [andExec()](UnauthorizedError.md#andexec)
  - [logError()](UnauthorizedError.md#logerror)
  - [logWarn()](UnauthorizedError.md#logwarn)
  - [map()](UnauthorizedError.md#map)
  - [matches()](UnauthorizedError.md#matches)
...
### new UnauthorizedError(args)

> **new UnauthorizedError**(...`args`): [`UnauthorizedError`](UnauthorizedError.md)
