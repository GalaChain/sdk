...
[API](../exports.md) > InvalidExpirationError

# Class: InvalidExpirationError

## Contents

- [Extends](InvalidExpirationError.md#extends)
- [Constructors](InvalidExpirationError.md#constructors)
  - [new InvalidExpirationError(expires)](InvalidExpirationError.md#new-invalidexpirationerrorexpires)
- [Properties](InvalidExpirationError.md#properties)
  - [code](InvalidExpirationError.md#code)
  - [key](InvalidExpirationError.md#key)
  - [message](InvalidExpirationError.md#message)
  - [name](InvalidExpirationError.md#name)
  - [payload](InvalidExpirationError.md#payload)
  - [stack](InvalidExpirationError.md#stack)
- [Methods](InvalidExpirationError.md#methods)
  - [andExec()](InvalidExpirationError.md#andexec)
  - [logError()](InvalidExpirationError.md#logerror)
  - [logWarn()](InvalidExpirationError.md#logwarn)
  - [map()](InvalidExpirationError.md#map)
  - [matches()](InvalidExpirationError.md#matches)
...
### new InvalidExpirationError(expires)

> **new InvalidExpirationError**(`expires`): [`InvalidExpirationError`](InvalidExpirationError.md)
...
[chaincode/src/locks/LockError.ts:35](https://github.com/GalaChain/sdk/blob/bcbbb18/chaincode/src/locks/LockError.ts#L35)
