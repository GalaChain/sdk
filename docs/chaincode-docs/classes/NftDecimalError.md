...
[API](../exports.md) > NftDecimalError

# Class: NftDecimalError

## Contents

- [Extends](NftDecimalError.md#extends)
- [Constructors](NftDecimalError.md#constructors)
  - [new NftDecimalError(decimals)](NftDecimalError.md#new-nftdecimalerrordecimals)
- [Properties](NftDecimalError.md#properties)
  - [code](NftDecimalError.md#code)
  - [key](NftDecimalError.md#key)
  - [message](NftDecimalError.md#message)
  - [name](NftDecimalError.md#name)
  - [payload](NftDecimalError.md#payload)
  - [stack](NftDecimalError.md#stack)
- [Methods](NftDecimalError.md#methods)
  - [andExec()](NftDecimalError.md#andexec)
  - [logError()](NftDecimalError.md#logerror)
  - [logWarn()](NftDecimalError.md#logwarn)
  - [map()](NftDecimalError.md#map)
  - [matches()](NftDecimalError.md#matches)
...
### new NftDecimalError(decimals)

> **new NftDecimalError**(`decimals`): [`NftDecimalError`](NftDecimalError.md)
...
[chaincode/src/token/TokenError.ts:20](https://github.com/GalaChain/sdk/blob/bcbbb18/chaincode/src/token/TokenError.ts#L20)
