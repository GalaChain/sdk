...
[API](../exports.md) > SameSenderAndRecipientError

# Class: SameSenderAndRecipientError

## Contents

- [Extends](SameSenderAndRecipientError.md#extends)
- [Constructors](SameSenderAndRecipientError.md#constructors)
  - [new SameSenderAndRecipientError(fromPersonKey, toPersonKey)](SameSenderAndRecipientError.md#new-samesenderandrecipienterrorfrompersonkey-topersonkey)
- [Properties](SameSenderAndRecipientError.md#properties)
  - [code](SameSenderAndRecipientError.md#code)
  - [key](SameSenderAndRecipientError.md#key)
  - [message](SameSenderAndRecipientError.md#message)
  - [name](SameSenderAndRecipientError.md#name)
  - [payload](SameSenderAndRecipientError.md#payload)
  - [stack](SameSenderAndRecipientError.md#stack)
- [Methods](SameSenderAndRecipientError.md#methods)
  - [andExec()](SameSenderAndRecipientError.md#andexec)
  - [logError()](SameSenderAndRecipientError.md#logerror)
  - [logWarn()](SameSenderAndRecipientError.md#logwarn)
  - [map()](SameSenderAndRecipientError.md#map)
  - [matches()](SameSenderAndRecipientError.md#matches)
...
### new SameSenderAndRecipientError(fromPersonKey, toPersonKey)

> **new SameSenderAndRecipientError**(`fromPersonKey`, `toPersonKey`): [`SameSenderAndRecipientError`](SameSenderAndRecipientError.md)
...
[chaincode/src/transfer/TransferError.ts:18](https://github.com/GalaChain/sdk/blob/bcbbb18/chaincode/src/transfer/TransferError.ts#L18)
