...
[API](../exports.md) > NoObjectIdsError

# Class: NoObjectIdsError

## Contents

- [Extends](NoObjectIdsError.md#extends)
- [Constructors](NoObjectIdsError.md#constructors)
  - [new NoObjectIdsError()](NoObjectIdsError.md#new-noobjectidserror)
- [Properties](NoObjectIdsError.md#properties)
  - [code](NoObjectIdsError.md#code)
  - [key](NoObjectIdsError.md#key)
  - [message](NoObjectIdsError.md#message)
  - [name](NoObjectIdsError.md#name)
  - [payload](NoObjectIdsError.md#payload)
  - [stack](NoObjectIdsError.md#stack)
- [Methods](NoObjectIdsError.md#methods)
  - [andExec()](NoObjectIdsError.md#andexec)
  - [logError()](NoObjectIdsError.md#logerror)
  - [logWarn()](NoObjectIdsError.md#logwarn)
  - [map()](NoObjectIdsError.md#map)
  - [matches()](NoObjectIdsError.md#matches)
...
### new NoObjectIdsError()

> **new NoObjectIdsError**(): [`NoObjectIdsError`](NoObjectIdsError.md)
...
[chaincode/src/utils/state.ts:40](https://github.com/GalaChain/sdk/blob/bcbbb18/chaincode/src/utils/state.ts#L40)
