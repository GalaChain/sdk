...
[API](../exports.md) > DuplicateUserError

# Class: DuplicateUserError

## Contents

- [Extends](DuplicateUserError.md#extends)
- [Constructors](DuplicateUserError.md#constructors)
  - [new DuplicateUserError(users)](DuplicateUserError.md#new-duplicateusererrorusers)
- [Properties](DuplicateUserError.md#properties)
  - [code](DuplicateUserError.md#code)
  - [key](DuplicateUserError.md#key)
  - [message](DuplicateUserError.md#message)
  - [name](DuplicateUserError.md#name)
  - [payload](DuplicateUserError.md#payload)
  - [stack](DuplicateUserError.md#stack)
- [Methods](DuplicateUserError.md#methods)
  - [andExec()](DuplicateUserError.md#andexec)
  - [logError()](DuplicateUserError.md#logerror)
  - [logWarn()](DuplicateUserError.md#logwarn)
  - [map()](DuplicateUserError.md#map)
  - [matches()](DuplicateUserError.md#matches)
...
### new DuplicateUserError(users)

> **new DuplicateUserError**(`users`): [`DuplicateUserError`](DuplicateUserError.md)
...
[chaincode/src/allowances/AllowanceError.ts:34](https://github.com/GalaChain/sdk/blob/bcbbb18/chaincode/src/allowances/AllowanceError.ts#L34)
