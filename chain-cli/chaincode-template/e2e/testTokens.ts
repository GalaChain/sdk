...
export const bnbClassKey = Object.assign(new TokenClassKey(), testTokens.BNB.KEY);
export const solClassKey = Object.assign(new TokenClassKey(), testTokens.SOL.KEY);
export const maticClassKey = Object.assign(new TokenClassKey(), testTokens.MATIC.KEY);
