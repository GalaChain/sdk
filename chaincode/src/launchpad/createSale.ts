import { CreateLaunchpadSaleDto, CreateLaunchpadSaleResponse, DefaultError, TokenInstanceKey, NativeTokenAmountDto, asValidUserAlias } from "@gala-chain/api";
import {
  GalaChainContext,
  getObjectByKey,
...
export async function createSale(
  ...
  launchPadDetails: CreateLaunchpadSaleDto
  ...
  const vaultAddress = asValidUserAlias(`service|${tokenInstanceKey.getTokenClassKey().toStringKey()}_launchpad`);
